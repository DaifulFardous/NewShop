...
<head>
    ...
    <link href="{{ asset('/') }}/font-awesome/{{ asset('/') }}/back-end/css/font-awesome.css" rel="stylesheet">
    ...
    <script src="{{ asset('/') }}/back-end/ckeditor/samples/../ckeditor.js"></script>
    ...
    <link rel="stylesheet" href="{{asset('/')}}/back-end/css/css/invoice.css">
...
<div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('/ManageCategory') }}">Manage Category</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
    ...
    <script src="{{asset('/')}}/back-end/js/js/invoice.js"></script>
</body>
<script>
    initSample();
</script>
