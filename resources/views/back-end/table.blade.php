...
<head>
    ...
    <link href="font-awesome/{{ asset('/') }}/back-end/css/font-awesome.css" rel="stylesheet">

    <!-- Page-Level Plugin CSS - Tables -->
    <link href="{{ asset('/') }}/back-end/css/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet">
...
<script src="{{ asset('/') }}/back-end/js/plugins/dataTables/jquery.dataTables.js"></script>
<script src="{{ asset('/') }}/back-end/js/plugins/dataTables/dataTables.bootstrap.js"></script>
